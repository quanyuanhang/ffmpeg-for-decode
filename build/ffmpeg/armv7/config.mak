...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --arch=arm --enable-cross-compile --cross-prefix=arm-linux-androideabi- --enable-shared --disable-symver --disable-doc --disable-ffplay --disable-ffmpeg --disable-ffprobe --disable-ffserver --disable-avdevice --disable-avfilter --disable-encoders --disable-muxers --disable-filters --disable-devices --disable-everything --enable-protocols --enable-parsers --enable-demuxers --enable-decoders --enable-bsfs --enable-network --enable-swscale --disable-demuxer=sbg --disable-demuxer=dts --disable-parser=dca --disable-decoder=dca --enable-asm --enable-version3 --prefix='/home/qyh/下载/FFmpeg-Android-master/build/ffmpeg/neon' --prefix='/home/qyh/下载/FFmpeg-Android-master/build/ffmpeg/armv7' --extra-cflags='-O3 -Wall -mthumb -pipe -fpic -fasm   -finline-limit=300 -ffast-math   -fstrict-aliasing -Werror=strict-aliasing   -fmodulo-sched -fmodulo-sched-allow-regmoves   -Wno-psabi -Wa,--noexecstack   -D__ARM_ARCH_5__ -D__ARM_ARCH_5E__ -D__ARM_ARCH_5T__ -D__ARM_ARCH_5TE__   -DANDROID -DNDEBUG -march=armv7-a -mfpu=vfpv3-d16 -mfloat-abi=softfp -I../jni_log/include' --extra-ldflags='-Wl,--fix-cortex-a8 -L../jni_log/lib -llog'
prefix=/home/qyh/下载/FFmpeg-Android-master/build/ffmpeg/armv7
...
CC_O=-o $@
CXX_O=-o $@
LDFLAGS= -Wl,--fix-cortex-a8 -L../jni_log/lib -llog -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
